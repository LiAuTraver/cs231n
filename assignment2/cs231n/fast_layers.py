...
def conv_forward_im2col(x, w, b, conv_param):
  ...
  x_cols = im2col_cython(x, w.shape[2], w.shape[3], pad, stride)  # type: ignore
...
def conv_backward_strides(dout, cache):
  ...
  dx = col2im_6d_cython(dx_cols, N, C, H, W, HH, WW,  # type: ignore
                        pad, stride)
...
conv_forward_fast: Callable = conv_forward_strides
conv_backward_fast: Callable = conv_backward_strides
...
def max_pool_forward_im2col(x, pool_param):
  ...
  x_cols = im2col(x_split, pool_height, pool_width,  # type: ignore
