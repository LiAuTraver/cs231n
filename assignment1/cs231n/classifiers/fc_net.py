...
class TwoLayerNet(object):
  ...
  def __init__(
    ...
    self.params['W1'] = np.random.normal(.0,
                                         weight_scale, (input_dim, hidden_dim))
    self.params['W2'] = np.random.normal(.0,
                                         weight_scale, (hidden_dim, num_classes))
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
  ...
  def loss(self, X, y=None):
    ...
    ############################################################################
    first_layer_output, first_layer_cache = \
        affine_relu_forward(X, self.params['W1'], self.params['b1'])
    scores, out_cache = \
        affine_forward(first_layer_output, self.params['W2'], self.params['b2'])
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
    ...
    input_gradient, dW2, db2 = \
        affine_backward(dscores, out_cache)
    out_gradient, dW1, db1 = \
        affine_relu_backward(input_gradient, first_layer_cache)
    grads = {}
