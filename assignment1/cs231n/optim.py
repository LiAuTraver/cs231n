...
def rmsprop(w, dw, config=None):
  ...
  #         A method to solve the problem of RProp(Resilient Backpropagation)
  #         which does not work well in mini-batch learning.
  # Keep moving average of squared gradients

  # The formula here references the presentation of Geoffrey Hinton.
...
def adam(w, dw, config=None):
  ...
  # just see the original paper [Adam paper (Kingma & Ba, 2015)],
  # and I didn't want to repeat it here it's too long and the paper is well-written.
  config["t"] += 1
  ...
  next_w = w - config["learning_rate"] * \
      m_hat / (np.sqrt(v_hat) + config["epsilon"])
  ###########################################################################
  #                             END OF YOUR CODE                            #
  ###########################################################################
