...
class EmojiDataset(Dataset):
  def __init__(
    ...
    data_path = os.path.join(os.path.dirname(__file__),
                             "datasets/emoji_data.npz")
    text_emb_path = os.path.join(os.path.dirname(
      __file__), "datasets/text_embeddings.pt")
  ...
  def __getitem__(self, idx):
    ...
    text_emb = self.text_embedder.embed(
      text=text, num_pca=self.num_text_emb_pca)
